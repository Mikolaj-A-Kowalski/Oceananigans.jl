...
function WENOVectorInvariant(FT::DataType = Oceananigans.defaults.FloatType;
    ...
    vorticity_scheme               = WENO(FT, FT2; order=vorticity_order, minimum_buffer_upwind_order, weno_kw...)
    vertical_advection_scheme      = WENO(FT, FT2; order=vertical_order, minimum_buffer_upwind_order, weno_kw...)
    kinetic_energy_gradient_scheme = WENO(FT, FT2; order=kinetic_energy_gradient_order, minimum_buffer_upwind_order, weno_kw...)
    divergence_scheme              = WENO(FT, FT2; order=divergence_order, minimum_buffer_upwind_order, weno_kw...)
